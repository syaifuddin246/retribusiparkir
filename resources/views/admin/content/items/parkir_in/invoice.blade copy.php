    ...
    <div class="container">
        ...
        <div class="left" style="padding-top:12px;">
            <ul style="font-size: 11px;">
                <li><b>PERBUP KABUPATEN DEMAK NOMOR 40 TAHUN 2020</b></li>
                <li><b>*Periksa kembali tiket anda untuk jumlah retribusi yang dibayarkan</b></li>
                <li><b>*Simpan tiket sebagai tanda bukti masuk kawasan wisata religi</b></li>
            </ul>
        </div>
